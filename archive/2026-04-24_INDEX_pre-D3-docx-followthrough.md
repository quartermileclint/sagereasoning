...
|--------|---------|-------------|
| /adopted/ | Current governing documents beyond the manifest | (V3 Adoption Scope `.md` files archived 2026-04-24 as completion records; V3 Adoption Scope `.docx` companions remain pending founder decision) |
