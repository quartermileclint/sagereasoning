...
Prior versions preserved: `/archive/2026-04-11_INDEX.md`, `/archive/2026-04-24_INDEX_pre-D3-edit.md`, `/archive/2026-04-24_INDEX_pre-D3-docx-followthrough.md`
...
|--------|---------|-------------|
| /adopted/ | Current governing documents beyond the manifest | Empty as of 2026-04-24 (V3 Adoption Scope `.md` files archived as completion records; `V3_Adoption_Scope.docx` deleted per founder directive — `.md` twin existed in archive; `V3_Adoption_Scope_Addendum_P12-P19.docx` archived to `/archive/2026-03-31_V3_Adoption_Scope_Addendum_P12-P19_completed.docx` as it contained unique P17–P19 content. `backup/` subfolder is a harmless D6-A migration placeholder) |
| /drafts/ | Documents under review, pending founder approval | Empty (`backup/` subfolder is a harmless placeholder from D6-A migration) |
