# SageReasoning — Decision Log Archive (April 2026)

**Source file:** `/operations/decision-log.md`
**Cutoff criterion:** entries dated 2026-04-01 to 2026-04-30 (inclusive).
**Move date:** 2026-05-04
**Move authority:** `D-DECISION-LOG-ARCHIVE-POLICY-ADOPTED-2026-05-04` (governance entry in `/operations/decision-log.md`)
**Cross-reference invariant:** entry IDs (e.g., `D-…-YYYY-MM-DD` or `DD-YYYY-MM-DD-NN`) remain stable across archive boundaries. To resolve an ID from elsewhere in the project, search by ID across the active log + all archive files in `/operations/`.

**Note on entry format:** entries dated 2026-04-05 to 2026-04-19 use the legacy English-format date convention. Entries dated 2026-04-20 onwards use the ISO date format adopted at that time.
