...
| --- | --- | --- | --- |
| **Standing-runner design** | **[R8: deliberately NOT resolved — carried untouched (design §9); no design element depends on it; REDIRECTED to a future doctrinal/mentor session of its own, not to the standing-runner track]** **§5d** — is oikeiosis-only the doctrinally right reading of a deliberating ruling faculty? Resolution is **engine-class, `code-critical`** | `agent-circles-2026-08/2026-08-23-evaluative-engine-status-documentation-map.md` §5d | `…/2026-08-24-mentor-ruling-deliberation-reading-open-question-routing-verbatim.md` |
...
| **Standing-runner design** | **[NOT YET RECEIVED BY ANY SESSION — R8 already ran 2026-08-30 and this instruction post-dates it; per this table's own framing note, the receiving session is the standing-runner track's NEXT design-capable session]** **GS-ATRF-1's blast-radius proxy — a candidate alternative basis, named 2026-09-01.** The 2026-08-11 ruled answer + classification vocabulary are UNTOUCHED; this offers a different underlying justification for the SAME proxy — blast radius as a topological property (the number and kind of expanding moves from the generalisation of the practitioner's current state), in place of task-level consequence assessment — "consistent with the proxy being disclosed as an assessed classification." Explicitly named a candidate for GS-ATRF-1's resolution, **not a ruling**; does not reopen or amend the 2026-08-11 ruling on its own | `2026-09-01-mentor-instruction-bidirectional-algorithm-verbatim.md` | same file (not yet ruled — a relayed instruction, no ruling request has been raised on it) |
| **Standing-runner design** | **[NOT YET RECEIVED BY ANY SESSION — same instruction, same status as the row above]** **The generation-step design — a candidate architecture, named 2026-09-01** (the "bidirectional/reverse algorithm" shape): anchor the practitioner's current state as the clean residual structure; insert generative fingers at virtue-domain and oikeiosis-circle branch points; apply expanding moves scored by the four-virtue evaluative layer; ground candidates in concrete actions; prune with a forward pass. Its topological continuous-connection-to-core constraint is offered as a possible structural analogue of the weights constraint, potentially addressing the **GS-CYB-1** concern without a numerical weighting function — but **GS-CYB-1's two independent conditions still gate any weighting/scoring function entering the generation step, unmoved by this instruction.** Named a candidate, **not a ruling** | `2026-09-01-mentor-instruction-bidirectional-algorithm-verbatim.md` | same file (not yet ruled) |
