...
| **Standing-runner design** | **[2026-09-04: a FINDING the session produces — whether it is also a CLOSE condition is an unresolved discrepancy inside the relay, named not chosen]** **The nine guardrail-rejected candidates under the new lens (environment tag; expanding-move distance).** The prior close gate is **DISCHARGED** by `2026-08-29-nine-candidate-remediation-shape-classification.md` (ruling A4: "retroactively requiring re-classification under a lens that postdates the gate would be moving the gate after the fact … It does not hold the close gate open pending that"). The governing brief's own final "Close gate" section nonetheless reads "The session's close is gated on one condition: the nine … must be classified under the new lens … as a session finding … not a precondition of opening." Both readings are preserved verbatim (Part 3; capture note §4.2). **Question DRAFTED 2026-09-04, awaiting the founder's relay decision:** `agent-circles-2026-08/2026-09-04-MENTOR-QUESTION-standing-runner-close-gate-discrepancy.md` — which also surfaces, from source, that NEITHER component of the new lens is retroactively applicable to these nine in the sense ruling C1 defines (no environment was or could be runner-attested for a run closed 2026-08-16, and no expanding-move measure exists or was performed), so a ruling here decides more than which sentence wins | `agent-circles-2026-08/2026-09-04-mentor-brief-standing-runner-design-session-and-rulings-verbatim.md` (Part 3 A4 + "Close gate") | same file |
