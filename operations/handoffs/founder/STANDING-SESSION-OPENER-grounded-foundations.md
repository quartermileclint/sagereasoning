...
| **S5 — NEXT** | D2 scope-for-ruling (`computeVirtueDomains` self-only dikaiosyne tagging; remedy location engine vs reducer; mirrors P1's shape) → relay | governance, autonomous; **before S4(d)** | queued | to author |
