...
**Founder steps outstanding:** the TEST revoke SQL (both TEST credential ids → `is_active=false`; non-blocking); the optional in-band sweep curl (follow-up 5 in the elections section).
