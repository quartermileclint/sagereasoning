...
**Mutation record** (14 mutations, hash-verified restore, all RED, post-restore GREEN): the token
...
## Honest limits, and three in-build corrections worth recording
...
Two of the three were found by the mutation harness, not by reading. That is the argument for
running it.
...
| 3 | **S5 — the next row** (D2 scope-for-ruling, autonomous, before S4(d)) | a Session S5 |
