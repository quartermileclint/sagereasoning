...
**Status (2026-08-03):** **BUILT + PR19-REVIEWED (folds applied; §5 item iii re-confirmed — aggregate stats off entirely; the raw auth UUID also dropped from the surface; the legacy graded-view migration neutralised). Founder-walked SQL apply + push + live smoke pending** — walk staged in `operations/handoffs/founder/2026-08-03-stoa-ST1-community-map-CLOSE.md`; decision `D-STOA-ST1-COMMUNITY-MAP-REPAIRED-DEGRADED-2026-08-03`.
