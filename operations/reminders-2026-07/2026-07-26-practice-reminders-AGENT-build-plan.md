...
**STATUS 2026-07-28: A1 is BUILT DARK + independently reviewed + review-folded** (`D-PRACTICE-REMINDERS-AGENT-A1-SUGGESTION-COMPOSER-BUILT-REVIEW-FOLDED`). Flag `SUBSTRATE_PRACTICE_SUGGESTION_ENABLED` unset everywhere ⇒ both surfaces byte-identical; nothing activated. Six build decisions recorded (BD-1a fold-open silence · BD-1b kathekon-gated B1 · BD-2 B5 silent · BD-3 carrier gating · BD-4 beyond-self circle · BD-5 weak-means-weak) plus **BD-6, forced by the review** — the B3 row above was a spec overreach and is now sub-species-differentiated. Batteries: practice-suggestion **515/0** (NEW) · loop-fold **181/0** · trajectory-delta 73/0 · trajectory-overlay 36/0 · aah-store 120/0 · kathekon 105/0 · practice-cycle-hint 13/0 · practice-sequence 645/0 · S4 417/0 · S10 106/0 · trust-core 98/0 · emission-hooks 15/0 · accreditation route 90/90 · `tsc` 0 · `npm run build` 0. **32/32 mutations killed.**
