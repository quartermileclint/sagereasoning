...
**A1 COMPLETE 2026-07-28** (dark; see §4's status block). **A2 COMPLETE 2026-07-28** (dark; see §5's status block). Next: **A3** (R18 docs + the founder-walked Critical activation, which is where A1 and A2 both go live).
