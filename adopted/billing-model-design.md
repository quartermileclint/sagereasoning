...
- `/adopted/sage-assent-a10-design.md` — structural template for this design's nine-decision-shape (extended here to eight decisions); A10 design Adopted, will be Superseded at session #5 of the new post-6b arc tail
