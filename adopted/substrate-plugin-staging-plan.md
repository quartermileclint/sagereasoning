...
```
A1 → A3 → A5 → A7 → A9
  → A10 → A11b → A12 → A13 → A15a (DONE 2026-05-30) → Stage 1 close
  → K1 → K2 → K3 → K7
...
| 17 | A15a R17c deletion endpoint (Critical) | A15a (DONE 2026-05-30, Verified-live) | — | Critical (R17) |
