...
**Status:** **Adopted (design of record) 2026-06-19** under `D-MECHANISM-CORRECTION-PART-B-GUARDRAIL-ACTIVATION-BLOCKED-FIDELITY-GAP-2026-06-19`. Dual-taxonomy (0a/0f): decision = **Adopted**; implementation = the **§3 near-term bridge is BUILT (Wired + TEST-Verified, dark** behind the existing `SUBSTRATE_GUARDRAIL_SANDWICH_ENABLED`; built 2026-06-19 under `D-MECHANISM-CORRECTION-PART-B-GUARDRAIL-JUSTICE-BRIDGE-BUILT-TEST-VERIFIED-2026-06-19`); the **§4 root correction remains Scoped** (a deeper engine session with its own battery + adversarial review).
