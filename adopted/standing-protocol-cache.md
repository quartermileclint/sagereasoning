...
- Process rules (PR1–PR18) — PR10–PR16 added under ST2 2026-05-12; PR15 amended 2026-05-14; PR17 (founder-performed operational steps walked through live, not handed off) added 2026-05-27 under `D-PR17-ADOPTED-WALKTHROUGH-2026-05-27`; PR18 (production-state blocks are close-time artifacts — rewritten only at session close, only from the decision log + that session's verified observations, always carrying an as-of date) added 2026-06-10 under `D-PR18-ADOPTED-CLOSE-TIME-PRODUCTION-STATE-2026-06-10`
...
- Project instructions: see `/adopted/project-instructions-snapshot.md` for the operative content (PR1–PR18; verification framework 0c; Critical Change Protocol 0c-ii; risk classification 0d-ii; AI signals diagnostic-certainty rows added ST2; PR15 amended 2026-05-14; PR17 added 2026-05-27; PR18 added 2026-06-10)
