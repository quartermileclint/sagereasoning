...
async function main() {
  ...
  console.log('\nNext step — LIVE PROBE (requires the routes to be deployed):')
  console.log('')
  console.log('A) MENTOR-RING proof:')
  ...
  console.log('     Expected: 200, JSON with before / inner_output / after / token_summary.')
  console.log('')
  console.log('B) SUPPORT-AGENT proof:')
  console.log('     curl -X POST https://sagereasoning.com/api/support/agent/proof \\')
  console.log('       -H "Authorization: Bearer <YOUR_BEARER_TOKEN>" \\')
  console.log('       -H "Content-Type: application/json" \\')
  console.log('       -d \'{')
  console.log('         "subject": "Question about my reflection score",')
  console.log('         "customer": "Test User",')
  console.log('         "channel": "email",')
  console.log('         "priority": "normal",')
  console.log('         "message": "I tried the reflection scorer yesterday and got a result I do not understand. Can you explain what deliberate proximity means?"')
  console.log('       }\'')
