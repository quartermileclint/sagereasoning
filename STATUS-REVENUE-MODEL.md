...
- Per-call pricing at 150% of the Anthropic API cost for the model used (claude-sonnet-4-6)
...
**Pricing rationale:** 150% of Anthropic API cost gives 50% gross margin before hosting/infrastructure. As volume grows, Anthropic volume pricing may widen this margin.
