...
| `public/.well-known/agent-card.json` | A2A (Agent2Agent) protocol discovery file (v1-shape; reshaped 2026-05-14) — declares 9 skills, rate limits, authentication schemes, and integration quickstart for autonomous agents |
...
| `public/.well-known/agent-card.json` → `sagereasoning.com/.well-known/agent-card.json` | A2A (Agent2Agent) protocol standard, v1-aligned — declares 9 skills, rate limits, authentication schemes, and a 6-step quickstart for autonomous agents. Reshape under `D-AGENT-CARD-A2A-V1-RESHAPE-2026-05-14` closed the gaps documented at `D-AGENT-CARD-CURRENCY-CHECK-2026-05-14`. | Website public folder |
