  ...
  if (loading) {
    return (
      <div className="max-w-6xl mx-auto px-6 py-20 text-center">
        <p role="status" className="font-body text-sage-600 text-lg">Loading your profile…</p>
      </div>
    )
  }
        ...
        <div className="bg-white/60 border border-sage-200 rounded-lg p-8 mb-8">
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="text-right">
              {baselineStatus?.retake_eligible ? (
                ...
                <div>
                  <span className="font-body text-xs text-sage-600 block">Retake available</span>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="text-center">
              <p className="font-body text-sm text-sage-600 mb-2">Progress Grade</p>
              <p
              ...
              <p className="font-body text-xs text-sage-600 mt-2">
          ...
          {baseline.interpretation && (
            <div className="mt-6 pt-6 border-t border-sage-100">
              ...
              <p className="font-body text-xs text-sage-600 mt-2 italic">
                * {BASELINE_DISCLAIMER}
              </p>
            </div>
          )}
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            <div className="bg-white/60 border border-sage-200 rounded-lg p-6 text-center">
              <p className="font-body text-sm text-sage-600 mb-2">Actions Evaluated</p>
              <p className="font-display text-4xl font-bold text-sage-800">{totalEvaluations}</p>
            </div>

            <div className="bg-white/60 border border-sage-200 rounded-lg p-6 text-center">
              <p className="font-body text-sm text-sage-600 mb-2">Most Common Proximity</p>
              <p
            ...
            <div className="bg-white/60 border border-sage-200 rounded-lg p-6 text-center">
              <p className="font-body text-sm text-sage-600 mb-2">Avg Passions per Action</p>
              <p className="font-display text-4xl font-bold text-sage-800">{avgPassionsPerAction}</p>
            </div>

            <div className="bg-white/60 border border-sage-200 rounded-lg p-6 text-center">
              <p className="font-body text-sm text-sage-600 mb-2">Direction of Travel</p>
          ...
          <div className="bg-white/60 border border-sage-200 rounded-lg p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <a href="/score" className="font-display text-sm text-sage-600 hover:text-sage-700 underline">Evaluate another</a>
            </div>
            ...
            <p className="font-body text-xs text-sage-600 mt-6 pt-4 border-t border-sage-100 italic">
              * {BASELINE_DISCLAIMER}
            </p>
          </div>
        </div>
