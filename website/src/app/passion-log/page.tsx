  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center text-sage-600 font-body">Loading passion log...</div>
      </div>
    )
  }
      ...
      {totalEvents > 0 && (
        <div className="grid grid-cols-4 gap-3 mb-6">
          <div className="bg-white border border-sage-200 rounded-lg p-3 text-center">
            ...
            <div className="font-body text-xs text-sage-600">Events</div>
          </div>
          <div className="bg-white border border-sage-200 rounded-lg p-3 text-center">
            <div className="font-display text-xl font-semibold text-sage-900">
              {events.filter(e => e.caught_before_assent).length}
            </div>
            <div className="font-body text-xs text-sage-600">Pre-assent</div>
          </div>
          <div className="bg-white border border-sage-200 rounded-lg p-3 text-center">
            <div className="font-display text-xl font-semibold text-sage-900">
            ...
            <div className="font-body text-xs text-sage-600">Classifier match</div>
          </div>
          <div className="bg-white border border-sage-200 rounded-lg p-3 text-center">
            <div className="font-display text-xl font-semibold text-sage-900">
            ...
            <div className="font-body text-xs text-sage-600">Catch rate (latest)</div>
          </div>
        </div>
      )}
          ...
          {showForm ? (
            <form onSubmit={handleSubmit} className="bg-white border border-sage-200 rounded-lg p-6 mb-6">
              ...
              <div className="mb-4">
                ...
                />
                <div className="flex justify-between font-body text-xs text-sage-600 mt-1">
                  <span>Mild</span>
                  <span>Moderate</span>
                  <span>Strong</span>
                  <span>Intense</span>
              ...
              <div className="mb-4">
                <label className="font-display text-sm font-medium text-sage-600 block mb-1">
                  False judgement
                  <span className="font-body text-xs text-sage-600 ml-2">What drove it?</span>
                </label>
                <textarea
              ...
              <div className="mb-6">
                <label className="font-display text-sm font-medium text-sage-600 block mb-1">
                  Description
                  <span className="font-body text-xs text-sage-600 ml-2">Optional — enables LLM classification</span>
                </label>
                <textarea
                  value={description}
            ...
            <div className="mb-6">
              ...
              <button
                onClick={resetForm}
                className="w-full border-2 border-dashed border-sage-200 rounded-lg p-4 text-center font-body text-sm text-sage-600 hover:border-sage-400 hover:text-sage-600 transition-colors"
              >
                + Log new event
              </button>
            </div>
                  ...
                  <div className="flex items-end gap-1 h-16">
                    {data.map((week) => (
                      <div key={week.week_start} className="flex-1 flex flex-col items-center">
                        ...
                        />
                        <span className="font-body text-[10px] text-sage-600 mt-1">
            ...
            <div className="bg-white border border-sage-200 rounded-lg p-5">
              ...
              <div className="flex items-center gap-4 mt-4 pt-3 border-t border-sage-100">
                <div className="flex items-center gap-1">
                  ...
                  <span className="font-body text-[10px] text-sage-600">Baseline (20%)</span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-3 h-px bg-sage-400" />
                  <span className="font-body text-[10px] text-sage-600">Target (35%)</span>
                </div>
              </div>
            </div>
          )}
