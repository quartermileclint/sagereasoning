...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Founder-elected 2026-08-18. `profile_summary` is the same caller-supplied
    // free-text field class as the journal-week routes, concatenated into the
    // generation input. Its RESPONSE twin (/api/mentor-baseline-response) has
    // been a perimeter member since the 2026-08-17 gap closure; screening the
