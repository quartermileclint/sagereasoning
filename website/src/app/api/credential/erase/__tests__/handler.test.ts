...
function makeDeps(over: Partial<EraseDeps>): Spy {
  ...
  const deps: EraseDeps = {
    ...
    erase: async (): Promise<StoreResult<ErasureResult>> => {
      ...
      return { ok: true, value: { trajectory_deleted: 2, trust_deleted: 0, collaboration_deleted: 3, reflect_deleted: 0, stoa_deleted: 0, watching_deleted: 0, billing_depersonalised: 1, warnings: [] } }
    },
