          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="text-right mt-1">
                <span className="font-body text-xs text-sage-600">{charCount} characters</span>
              </div>
            </div>
        ...
        {result && (
          <div className="space-y-6">
            ...
            <div className="bg-sage-50 rounded-lg p-4">
              <span className="font-body text-xs text-sage-600 block mb-2">Your draft</span>
            ...
            {result.poster_passions.length > 0 && (
              <div className="bg-white border border-sage-200 rounded-lg p-6">
                ...
                <p className="font-body text-xs text-sage-600 mb-3">
