...
const tiers = [
  {
    ...
    features: [
      ...
      'Full Stoic Brain data access',
      'Developer API (1,000 free calls/month)',
    ],
  ...
  },
  {
    ...
    price: '$0.01',
    period: '/scored call',
    annualNote: '1,000 free calls/month included',
    description: 'Integrate the Stoic Brain into your own AI systems. Pay only for what you use.',
    features: [
      '1,000 free API calls per month',
      '$0.01 per scoring call (action, document, conversation)',
      '$0.005 per guardrail check',
      'Stoic Brain data retrieval always free',
