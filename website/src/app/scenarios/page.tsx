      ...
      <div className="max-w-3xl mx-auto">
            ...
            <div className="grid gap-3">
              {AUDIENCES.map((a) => (
                ...
                >
                  ...
                  <p className="font-body text-sage-600 text-sm mt-1">{a.description}</p>
                </button>
              ))}
            </div>
        ...
        {step === 'respond' && scenario && (
          <div className="space-y-6">
            ...
            <div className="text-center font-body text-sage-600 text-sm">— or write your own —</div>
                ...
                {(['reflexive', 'habitual', 'deliberate', 'principled', 'sage_like'] as const).map((level) => (
                  <div
                    ...
                    className={`flex-1 text-center py-1 text-xs font-body ${
                      level === result.katorthoma_proximity ? 'font-bold' : 'text-sage-600'
                    }`}
                ...
                {result.kathekon_assessment ? (
                  <>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="font-body text-sm text-sage-600">Quality: {result.kathekon_assessment.quality.charAt(0).toUpperCase() + result.kathekon_assessment.quality.slice(1)}</span>
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-body text-sm text-sage-600">Appropriate-Action Quality</span>
                  </div>
                )}
              </div>
            )}
            ...
            {result.control_filter && (
              <div className="bg-white border border-sage-200 rounded-lg p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <span className="font-body text-xs text-sage-600 block mb-2">Within Your Control</span>
                  ...
                  <div>
                    <span className="font-body text-xs text-sage-600 block mb-2">Outside Your Control</span>
                    <ul className="space-y-1">
            ...
            {result.passions_detected && result.passions_detected.length > 0 && (
              <div className="bg-white border border-sage-200 rounded-lg p-6">
                ...
                {result.false_judgements && result.false_judgements.length > 0 && (
                  <div className="mt-3">
                    <span className="font-body text-xs text-sage-600 block mb-2">All False Judgements</span>
                    <ul className="space-y-1">
