 ...
 * regulatory_references: [CR-005, CR-009, CR-011, CR-012]
 * review_cycle: quarterly
 * owner: legal-counsel
 * next_review_due: 2026-07-06
 * change_trigger: [AU Privacy Act reform, GDPR amendment, EU AI Act transparency obligations]
    ...
    <div className="max-w-3xl mx-auto px-6 py-16 font-body text-sage-800">
      ...
      <div className="mb-10">
        ...
        <p className="text-sage-600 text-sm italic">
          Last updated: June 2026 &mdash; Draft pending legal review
        </p>
      ...
      <section className="space-y-8 leading-relaxed">
        ...
        <div>
          ...
          <p>
            ...
            Our Supabase project is hosted in the <strong>United States (US East / North Virginia)</strong>.
            Supabase complies with applicable data protection laws. By creating an account you consent
            to this cross-border storage in the United States.
          </p>
          <p className="mt-3">
            Our application is hosted on <strong>Vercel</strong>, a US-based hosting and compute
            platform. Vercel processes your request and response data transiently in the United States
            while the application runs; it does not permanently store your account or score data
            (that is held by Supabase).
          </p>
          {/* Supabase project region: US East (North Virginia), project ref jdbefwkonfbhjquozgxr
              (region corrected 2026-06-07, LRQ-4; previously listed an Asia-Pacific region). Vercel
              added as hosting/compute sub-processor. Aligns with /compliance/sub-processor-register.md. */}
        </div>

        <div>
          <h2 className="font-display text-xl font-semibold text-sage-800 mb-3">5. Automated Decision-Making</h2>
          <p>
            SageReasoning uses AI (Anthropic&rsquo;s Claude) to generate Stoic reasoning assessments and
            written reflections on actions, documents, and other content you submit. These are
            automated outputs produced <strong>without human review</strong>, and they could
            significantly affect how you perceive your own decisions and character.
          </p>
          <p className="mt-3">
            In preparation for the automated decision-making transparency obligations under the amended{' '}
            <em>Privacy Act 1988</em> (Cth) (effective 10 December 2026), we disclose: the personal
            information used by these automated processes is the text you submit describing actions,
            decisions, or situations. The kinds of automated outputs produced include qualitative
            reasoning-proximity assessments (reflexive, habitual, deliberate, principled, sage-like),
            passion-diagnostic results identifying specific false judgements, unified virtue-domain
            engagement indicators, and AI-generated philosophical reflection. No numeric scores are produced.
          </p>
          <p className="mt-3">
            These outputs are for personal reflection only. They do not constitute formal assessments,
            professional advice, or any decision made about you by SageReasoning. Because they are
            AI-generated they may contain errors &mdash; you should apply your own judgement. You can
            request human review of any output, or correct or delete it, by using the tools in your{' '}
          ...
          {/* APP 1.7 automated decision-making transparency: region/Vercel/ADM transparency
              strengthened 2026-06-07 (LRQ-4). Final binding legal wording deferred to the
              Stage-1-close lawyer engagement (LRQ-3/LRQ-4). Do not assert "APP 1.7 compliant" until then. */}
        </div>
