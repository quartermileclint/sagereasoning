/**
 * PORTED — verbatim mirror of /trust-layer/card/accreditation-card.ts
 *
 * Source of truth: /trust-layer/card/accreditation-card.ts (built 3 April 2026).
 * Ported into website/src/lib/substrate/trust-layer/ on 2026-05-15 under
 * D-ATL-BADGE-SCHEMA-PERSISTENCE-WIRED-VERIFIED-2026-05-15 (the ATL Wrapper
 * build — spec step 6a, the badge foundation).
 ...
 *
 * This file is Component 3 (the badge) — the displayable accreditation card.
 * buildAccreditationCard + serializeCard render an AccreditationRecord into the
 * at-a-glance credential the public endpoint and the developer hand-back report
 * (spec step 6b and the trajectory-enriched hand-back report) serve.
 *
 * KEEP IN SYNC: if /trust-layer/card/accreditation-card.ts changes, re-port it
 *   here in the same change. Everything below the banner is a VERBATIM copy.
 *   The relative import path (../types/accreditation) is verbatim — the ported
 *   directory structure mirrors /trust-layer/ exactly so it resolves unchanged.
 * ===========================================================================
 */
