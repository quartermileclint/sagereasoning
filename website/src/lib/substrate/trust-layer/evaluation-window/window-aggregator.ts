/**
 * PORTED — verbatim mirror of /trust-layer/evaluation-window/window-aggregator.ts
 *
 * Source of truth: /trust-layer/evaluation-window/window-aggregator.ts
 *   (built 3 April 2026).
 ...
 *
 * Component 4 (trajectory awareness): the ATL Wrapper drives computeWindowSnapshot
 * off its accumulated EvaluatedAction[].
 *
