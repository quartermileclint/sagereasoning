/**
 * PORTED — verbatim mirror of /trust-layer/accreditation/public-endpoint.ts
 *
 * Source of truth: /trust-layer/accreditation/public-endpoint.ts
 *   (built 3 April 2026).
 ...
 *
 * KEEP IN SYNC: if /trust-layer/accreditation/public-endpoint.ts changes,
 *   re-port it here in the same change. Everything below the banner is a
 *   VERBATIM copy. The relative import paths (../types/accreditation,
 *   ./accreditation-record) are verbatim — the ported directory structure
 *   mirrors /trust-layer/ exactly so they resolve unchanged.
 * ===========================================================================
 */
