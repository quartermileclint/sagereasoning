/**
 * PORTED — verbatim mirror of /trust-layer/accreditation/accreditation-record.ts
 *
 * Source of truth: /trust-layer/accreditation/accreditation-record.ts
 *   (built 3 April 2026).
 ...
 * See ../types/accreditation.ts banner for why the 5-file closure is ported.
 *
 * This file is in the dependency closure of computeWindowSnapshot +
 * evaluateGradeTransition (it supplies PROXIMITY_RANK, PROXIMITY_TO_GRADE,
 * proximityToAuthority). The ATL Wrapper also calls createAccreditationRecord
 * directly to seed a fresh wrapped agent's starting credential.
 *
 * KEEP IN SYNC: if /trust-layer/accreditation/accreditation-record.ts changes,
 *   re-port it here in the same change. Everything below the banner is a
 *   VERBATIM copy. The relative import paths (../types/accreditation) are
 *   verbatim — the ported directory structure mirrors /trust-layer/ exactly so
 *   they resolve unchanged.
 * ===========================================================================
 */
