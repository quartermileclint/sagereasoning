...
export const SKILL_REGISTRY: SkillContract[] = [
  ...
  },
  {
    ...
    cost_speed: '~$0.18 per iteration, ~2s',
  ...
  },
  {
    ...
    name: 'sage-classify',
    tier: 'tier2_evaluation',
    outcome: 'Reasoned classification — routes input to a category with reasoning quality assessment, passion flags, and oikeiosis mapping. Designed for OpenBrain AI Sorter integration.',
    cost_speed: '~$0.18, ~2s',
