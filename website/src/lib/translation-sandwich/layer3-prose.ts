...
export interface Layer3Prose {
  ...
  consumer: Layer3Consumer
  /** 2–3 sentences of Stoic reflection. Per ADR-004 §2.4 + ADR-007 §3. */
...
function fallbackPhilosophicalReflection(assessment: Layer2Assessment): string {
  ...
  return `${proximityOpener}${passionSentence}${virtueSentence}${closingSentence}${kathekonNullSentence}${singleSnapshotSentence}`.trim()
}
